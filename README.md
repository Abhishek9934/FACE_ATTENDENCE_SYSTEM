...
Item Name : Face Attendance System <br>
Item Version : v 1.0 <br>
Developer : [Abhishek Kumar Gupta](https://www.linkedin.com/in/abhishek-kumar-gupta-9b7381176/) <br>
--
...
<img src="static/portal.png">

## Faculty Instructions
#### Faculty in order to use this app first needs to register on the application.

 <img class="thumbnail" src="static/fac_reg.jpg" style="width: 100%">


#### After creating the account faculty can login to his account.
 <img class="thumbnail" src="static/faclogin.png" style="width: 100%">
...
<img class="thumbnail" src="static/regclass.png" style="width: 100%">
  <img class="thumbnail" src="static/regclass2.png" style="width: 100%">
 


#### Teacher can view the class details by clicking on a particular class.

<img class="thumbnail" src="static/teachpanel.png" style="width: 100%">
         <img class="thumbnail" src="static/class.png" style="width: 100%"> <br> <br>
...
<img class="thumbnail" src="static/markatt.png" style="width: 100%">
...
<img class="thumbnail" src="static/markform.png" style="width: 100%">



#### The user can edit/delete or add a single student.

<img class="thumbnail" src="static/adddel.png" style="width: 100%">
...
<ol>
        <li>Students in order to use this app first needs to register on the application.</li>
                 <img class="thumbnail" src="static/studentreg.png" style="width: 100%">
 <br> <br>
        <li> After creating the account student can login to his account.</li> <br> <br>
         <img class="thumbnail" src="static/stulogin.png" style="width: 100%"> <br> <br>
          <li> In the student panel he/she can view all his enrolled classes.</li>
        <img class="thumbnail" src="static/studentpanel.png" style="width: 100%">

 <br> <br>
        <li> He can see the details on his class home page such as attendance details. </li> <br> <br>
                 <img class="thumbnail" src="static/studentpage.png" style="width: 100%"> <br> <br>
